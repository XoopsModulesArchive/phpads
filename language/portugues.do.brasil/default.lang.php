...
$GLOBALS['strHighPriority']					= "Show banners in this campaign with high priority.<b?>											   If you use this option phpAdsNew will try to distribute the
											   number of AdViews evenly over the course of the day.";
$GLOBALS['strLowPriority']					= "Show banner in this campaign with low priority.<b?>											   This campaign is used to show the left over AdViews which

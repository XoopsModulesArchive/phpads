...
$GLOBALS['strUpdateServerDown']				= "
    Due to an unknown reason it isn't possible to retrieve <b?>	information about possible updates. Please try again later.
";
//
...
$GLOBALS['strConvertExplaination']			= "
	You are currently using the compact format to store your statistics, but there are <b?>	still some statistics in verbose format. As long as the verbose statistics aren't  <b?>	converted to compact format they will not be used while viewing these pages.  <b?>	Before converting your statistics, make a backup of the database!  <b?>	Do you want to convert your verbose statistics to the new compact format? <b?>";
//
$GLOBALS['strConvertingExplaination']		= "
	All remaining verbose statistics are now being converted to the compact format. <b?>	Depending on how many impressions are stored in verbose format this may take a  <b?>	couple of minutes. Please wait until the conversion is finished before you visit other <b?>	pages. Below you will see a log of all modification made to the database. <b?>";
//
$GLOBALS['strConvertFinishedExplaination']  = "
	The conversion of the remaining verbose statistics was succesful and the data <b?>	should now be usable again. Below you will see a log of all modification made <b?>	to the database.<b?>";
//
//
?>